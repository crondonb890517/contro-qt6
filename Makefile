...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = contro1.0.0
DISTDIR = /workspace/.tmp/contro1.0.0
LINK          = g++
...
contro: ui_mainwindow.h ui_contractdialog.h ui_entidaddialog.h $(OBJECTS)  
